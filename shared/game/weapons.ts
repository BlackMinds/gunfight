...
export type WeaponProgress = { level: number; exp: number; stars: number }
...
export const weaponCatalog: WeaponDefinition[] = [
  ...
  { key: 'assault-rifle', name: '制式突击步枪', category: '突击步枪', rarity: '精良', level: 1, unlockLevel: 8, damage: 19, fireRate: 5.1, range: 650, bulletSpeed: 820, pierce: 1, spread: 0.075, projectiles: 1, element: '物理', statusChance: 0.14, attackPattern: 'automatic', magazineSize: 30, reloadTime: 1.55, critRate: 0.04, critDamage: 1.75, knockback: 18, explosionRadius: 0, chainCount: 0, chargeTime: 0, maxLevel: 120, maxStars: 5, slotCount: 6, fixedTrait: '战术泛用：移动射击不增加扩散', traits: ['均衡扫射', '移动射击', '穿透入门'] },
...
export function emptyWeaponProgress(): WeaponProgressMap {
  return Object.fromEntries(weaponCatalog.map((weapon) => [weapon.key, { level: 1, exp: 0, stars: 0 }]))
}
...
const setAttachments: Attachment[] = [
  ...
  { name: '风暴枪口', slot: '枪口', rarity: '传说', effect: '伤害 +18% / 射速 +12%', bonuses: { damage: 0.18, fireRate: 0.12 }, setKey: '雷暴执行者', specialEffect: '连续命中触发范围冲击波' },
  { name: '量子弹匣', slot: '弹匣', rarity: '神话', effect: '射速 +24% / 暴击率 +8%', bonuses: { fireRate: 0.24, critRate: 0.08 }, setKey: '雷暴执行者', specialEffect: '每第 6 发附加额外伤害' },
  { name: '轨道枪管', slot: '枪管', rarity: '传说', effect: '伤害 +22% / 穿透 +2', bonuses: { damage: 0.22, pierce: 2 }, setKey: '穿甲猎手', specialEffect: '穿透伤害不再衰减' },
  ...
  { name: '虚空弹芯', slot: '弹芯', rarity: '神话', effect: '伤害 +42% / 穿透 +2', bonuses: { damage: 0.42, pierce: 2 }, setKey: '穿甲猎手', specialEffect: '部分伤害转为能量并无视护甲' },
  { name: '血契模块', slot: '模块', rarity: '史诗', effect: '最大生命 +42', bonuses: { maxHp: 42 }, setKey: '血色幸存者' },
  { name: '相位枪托', slot: '枪托', rarity: '神话', effect: '移速 +18% / 最大生命 +36', bonuses: { speed: 0.18, maxHp: 36 }, setKey: '血色幸存者', specialEffect: '低生命时触发相位闪避' },
  { name: '急救芯片', slot: '芯片', rarity: '史诗', effect: '最大生命 +38 / 拾取 +20', bonuses: { maxHp: 38, pickup: 20 }, setKey: '血色幸存者' },
  { name: '堡垒枪托', slot: '枪托', rarity: '传说', effect: '最大生命 +54', bonuses: { maxHp: 54 }, setKey: '血色幸存者', specialEffect: '静止时获得护盾' },
  { name: '血色弹匣', slot: '弹匣', rarity: '传说', effect: '射速 +14% / 最大生命 +24', bonuses: { fireRate: 0.14, maxHp: 24 }, setKey: '血色幸存者' },
  { name: '财阀芯片', slot: '芯片', rarity: '传说', effect: '经验 +24% / 伤害 +12%', bonuses: { expGain: 0.24, damage: 0.12 }, setKey: '黄金后勤', specialEffect: '金币收益提高并转化为攻击' },
  ...
  { name: '终局芯片', slot: '芯片', rarity: '神话', effect: '射速 +24% / 经验 +30%', bonuses: { fireRate: 0.24, expGain: 0.3 }, setKey: '黄金后勤', specialEffect: '强化当前件数最高的套装效果' },
  ...
  { name: '死线模块', slot: '模块', rarity: '神话', effect: '伤害 +36% / 最大生命 +30', bonuses: { damage: 0.36, maxHp: 30 }, setKey: '黑域终端', specialEffect: '低生命时提高吸血和伤害' },
  { name: '黑洞模块', slot: '模块', rarity: '神话', effect: '伤害 +32% / 拾取 +36', bonuses: { damage: 0.32, pickup: 36 }, setKey: '黑域终端', specialEffect: '周期牵引并爆发' },
  { name: '战术 AI 芯片', slot: '芯片', rarity: '传说', effect: '射速 +20% / 暴击率 +7%', bonuses: { fireRate: 0.2, critRate: 0.07 }, setKey: '黑域终端', specialEffect: '优先锁定最高威胁目标' },
  { name: '黑域枪管', slot: '枪管', rarity: '神话', effect: '伤害 +34% / 穿透 +2', bonuses: { damage: 0.34, pierce: 2 }, setKey: '黑域终端', specialEffect: '击败精英后短时间提升全属性' }
]
